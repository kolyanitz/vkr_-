        ...
        def update_chart(graph_type):
            ...
            with catastrophe_container:
                ...
                if nn_model and nn_report:
                    ...
                    if 'weighted avg' in nn_report:
                        st.metric("F1 (взвешенная)", f"{nn_report['weighted avg']['f1-score']:.2f}")
                        st.metric("Precision (взвешенная)", f"{nn_report['weighted avg']['precision']:.2f}")
                        st.metric("Recall (взвешенная)", f"{nn_report['weighted avg']['recall']:.2f}")
